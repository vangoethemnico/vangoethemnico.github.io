...
const TRANSLATIONS = {
  nl: {
    ...
    hero_h1_2: "zonder",
    hero_h1_3: "gedoe.",
    hero_p1: "AI: er is al ongelooflijk veel over gezegd en geschreven. Vaak opgeklopte lucht en broodjes aap verhalen. En altijd wel iemand met een agenda die een of andere mening of product probeert te verkopen.",
    ...
    hero_btn_start: "Start je traject",
    ...
    session_0_title: "Hoe het werkt",
    session_0_intro: "Heb je je ooit al afgevraagd welke magie er verscholen zit onder grote taalmodellen zoals ChatGPT, Claude of Gemini?",
    session_0_detail: "We doorlopen samen de basisconcepten van AI modellen en geven antwoorden op vragen als: Waarom begrijpt zo'n model me soms wel en soms ook weer helemaal niet? Waarom komt er steeds een ander antwoord uit? In hoeverre denkt zo'n model zoals een mens? <br/><br/>De wonden die je lessen wiskunde en biologie hebben achtergelaten op je ziel? Sorry daar gaan we toch nog eens aan krabben. Maar geen zorgen: we houden het licht en luchtig en zorgen dat iedereen mee kan volgen.",
    session_1_title: "Inspiratie",
    session_1_intro: "In deze sessie nemen we je mee door de weg die AI heeft afgelegd, vanwaar we komen en waar we vandaag staan.",
    session_1_detail: "We tonen wat toepassingen van wat AI vandaag kan, maar proberen ook al een blik op de toekomst te werpen. Niemand kan de toekomst exact voorspellen uiteraard, maar je krijgt de ingrediënten om zelf je mening te vormen.",
    session_2_title: "Creatief met AI",
    session_2_intro: "Van beeldgeneratie tot muziek. We overlopen prompting tips en laten zien hoe je van jezelf zo'n perfect studio portret kan maken.",
    ...
    session_5_intro: "AI is de perfecte partner in crime om te studeren of informatie te verwerken.",
    session_5_detail: "We tonen stap voor stap hoe je uitsluitend met gratis tools aan de slag kunt gaan en welke ongelofelijke resultaten er mee te halen zijn voor school, werk of hobby.",
    ...
    cta_desc: "Kies voor een losse sessie of een op maat gemaakt traject voor jouw team. Geen gedoe, alleen pure waarde.",
    cta_btn_message: "Stuur een bericht",
    footer_copyright: "© 2026 Al zonder gedoe. Nico Van Goethem & Sofie Embrechts Podevyn.",
  ...
  en: {
    ...
    hero_p2: "Our mission is to explain in simple human language how it works and what it can and cannot do. Without the hassle and for everyone.",
    ...
    session_0_title: "How it works",
    session_0_intro: "Have you ever wondered what magic is hidden under large language models like ChatGPT, Claude or Gemini?",
    session_0_detail: "Together we walk through the basic concepts of AI models and provide answers to questions like: Why does such a model sometimes understand me and sometimes not at all? Why does a different answer come out every time? To what extent does such a model think like a human? <br/><br/>The wounds that your math and biology lessons left on your soul? Sorry, we're going to scratch those again. But don't worry: we keep it light and airy and ensure everyone can follow along.",
    session_1_title: "Inspiration",
    session_1_intro: "In this session we take you through the path AI has traveled, where we come from and where we are today.",
    session_1_detail: "We show some applications of what AI can do today, but also try to cast a glance at the future. No one can predict the future exactly, of course, but you get the ingredients to form your own opinion.",
    session_2_title: "Creative with AI",
    session_2_intro: "From image generation to music. We go over prompting tips and show you how to make a perfect studio portrait of yourself.",
    session_2_detail: "Videos and music are also within reach. Better well stolen than poorly made: we show how you can adopt a certain style for your own creations.",
    session_3_title: "Tinkering with AI",
    session_3_intro: "Most people only use a fraction of what AI is capable of.",
    session_3_detail: "Even by using exclusively free tools, you can get a long way and easily create your own applications. We provide inspiration with practical examples and show step by step how to start without any prior knowledge.",
    session_4_title: "Prompting basics",
    session_4_intro: "Prompting: how you give commands to AI models.",
    session_4_detail: "Just as we all learned to read, cycle, and google; this is also a skill that becomes very simple once you know it. Once you learn the tricks, you will notice that your results improve and that such a language model suddenly starts to understand you better.",
    session_5_title: "Studying with AI",
    session_5_intro: "AI is the perfect partner in crime for studying or processing information.",
    session_5_detail: "We show step by step how you can get started using exclusively free tools and what incredible results can be achieved for school, work, or hobbies.",
    about_title: "About Us",
    about_desc: "Nico Van Goethem and Sofie Embrechts Podevyn combine their expertise in innovation and communication to make AI accessible to everyone. We believe that technology is strongest when it strengthens the human factor, not replaces it.",
    founder_click_bio: "Click for bio",
    founder_nico_role: "Speaker",
    founder_sofie_role: "Bookings",
    bio_nico: '<p class="mb-4">When I was 12, I got my first computer. With my savings, I cycled to the bookstore to buy a book to learn programming. Besides that, I had another hobby: taking every device apart to see what was inside.</p><p class="mb-4">Those passions never went away: I became an industrial engineer in electronics and spent my entire career in positions where technology and \'figuring out how something works\' were important. From developer to architect to being responsible for digital strategy and innovation at SD Worx. AI is therefore naturally a big part of my focus.</p><p class="mb-4">I try to follow all perspectives, from technology and mathematics to the impact on our ecology and society. At the high speed this topic evolves: a serious challenge.</p><p class="mb-4">My mission with these sessions is to explain in simple human language and with many examples, interactive demos, and some humor (also dad jokes, I\'m trying to cut back but it\'s hard) how it works and what you can do with it.</p><p class="mb-4">I provide context for you to form your own opinion and hopefully also get inspired to do something with it (whatever that \'something\' may be). No sales pitches for the umpteenth magic product and no boring business talk.</p><p class="mb-4">Do I know everything? Absolutely not, and the more I delve into it, the more ends up on the to-discover pile. So don\'t expect a self-proclaimed guru, but just a person trying to follow and wanting to share his enthusiasm about this fascinating topic.</p><p>AI in simple human language, without the hassle...</p>',
    bio_sofie: '<p class="mb-4">The passion and interest in science came to me in secondary school. Chemistry turned out to be my natural habitat, and I therefore chose to study industrial engineering with a specialization in chemistry. That\'s how I ended up at Procter & Gamble, where I work with great passion as a researcher in the analytical lab. I use AI on a daily basis in my work environment. It makes my work as a researcher so much more powerful.</p><p class="mb-4">In addition to my passion for science and technology, I am also the mother of our two sons with much love and pleasure. AI is also my best friend there: from supporting our children in their schoolwork to optimizing the energy use of our household appliances.</p><p>Would you like to book a session or do you have practical questions? <br/>Then you can come to me!</p>',
    cta_title: "Ready to start?",
    cta_desc: "Choose a single session or a tailor-made trajectory for your team. No hassle, just pure value.",
