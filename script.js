...
const TRANSLATIONS = {
  nl: {
    ...
    session_0_intro: "Heb je je ooit al afgevraagd welke magie er verscholen zit onder grote taalmodellen zoals ChatGPT, Claude of Gemini? Net zoals je geen garagist hoef te zijn om een auto te besturen, helpt het wel om te weten hoe een koppeling werkt. Dat is bij AI net hetzelfde: als je de basisconcepten begrijpt, zal je merken dat je er veel meer mee kan. In deze sessie nemen we je mee onder de motorkap van AI modellen en leggen we uit hoe ze werken, maar dan simpel en zonder gedoe.",
