...
const TRANSLATIONS = {
  ...
  en: {
    ...
    cta_desc: "Choose a single session or a tailor-made trajectory for your team or organization. No fuss, simple languagehype, just plain language, for everyone.",
